...
const RateCommand = {
  ...
  async findByProductIdByUser(page, size, productId, store = null) {
    const url = `${Constants.HOSTNAME_DEFAULT}/api/info/rate/pageable?page=${page}&size=${size}&productId=${productId}`;
